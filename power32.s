#### assemble with as --32 and link with ld -melf_i86 ####
...
_start:
  ...
  addl $0x8, %esp	    # move the stack pointer back
...
power:
  ...
  movl 4(%ebp), %ebx    # put first argument in %eax
  movl 8(%ebp), %ecx    # put second argument in %ecx
